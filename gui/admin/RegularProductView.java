...
public class RegularProductView extends JPanel implements ActionListener, ItemListener {
    private String filename = "./files/itemRegularList.sms";
    ...
    private String[] tableTitle = { "ID", "Product Name", "Type", "Stocks", "Price", "CreatedAt" };
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == updateBtn) {
            ...
            if (tableIndex.length == 0) {
                ...
                priceUpdateField.setText(tableModel.getValueAt(tableIndex[0], 4).toString());
                ...
                updateConfirmBtn.setBounds(20, 200, 120, 30);
        ...
        if (e.getSource() == createConfirmBtn) {
            ...
            if (creatingName.equals("") ||
                ...
                productArray = productManager.getObjectFromText(filename);
                Product newProduct = new RegularProduct(pid, creatingName,
                        creatingType, creatingStock, creatingPrice, LocalDate.now().toString());
        ...
        if (e.getSource() == createBtn) {
            createFrame = new JFrame("Creating Box");
    ...
    public void tableRender(Product[] productList) {
        ...
        for (int i = 0; i < productList.length; i++) {
            ...
            itemData[i][5] = productList[i].getPublishedAt();
        }
