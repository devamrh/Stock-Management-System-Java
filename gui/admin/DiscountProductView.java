...
public class DiscountProductView extends JPanel implements ActionListener, ItemListener {
    ...
    private String[] tableTitle = { "ID", "Product Name", "Type", "Stocks", "Discount Price", "Discount", "Real Price", "CreatedAt" };
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == updateBtn) {
            ...
            if (tableIndex.length == 0) {
                ...
                JLabel percentage = new JLabel("Discount (%): ");
        ...
        if (e.getSource() == createConfirmBtn) {
            ...
            if (creatingName.equals("") ||
                ...
                productArray = productManager.getObjectFromText(filename);
                Product newProduct = new DiscountProduct(pid, creatingName,
